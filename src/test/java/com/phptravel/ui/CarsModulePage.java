...
public class CarsModulePage {

	/**
	 * Targets for Hotels Module Content.
	 */
	public static final Target CARS_MODULE_HEADER = Target.the("Offers Module Header")
			.locatedBy("//h2[@class='wow fadeIn upper animated'][text()='Offers module features']")
			.waitingForNoMoreThan(Duration.ofSeconds(10));
	public static final Target CARS_MODULE_LINE1 = Target.the("Offers Module Paragraph")
